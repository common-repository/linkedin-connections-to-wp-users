...
*/
 	function azalaan_admin_page() 
		...
		function azalaan_importer_actions() 
		{
		    ...
		    add_menu_page( 'Import Linkedin Connections', 'Import Linkedin Connections', 'manage_options','azalaan_linkedin_importer', 'azalaan_admin_page', plugins_url( 'linkedin-connections-to-wp-users/icon.png' ),6);
		}
