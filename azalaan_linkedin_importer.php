...
<?php    echo "<h2>" . __( 'Import Linkedin Connections from .csv file', 'add_links' ) . "</h2>"; ?>
 ...
 <input type="submit" class="button button-primary" name="Submit" style="margin-left:10px;" value="<?php _e('Import Users', 'import_users' ) ?>" />
            ...
            Download your Linkedin Connection <a href="https://www.linkedin.com/people/export-settings"> CSV</a>   |  More Details <a href="https://www.linkedin.com/pulse/20141120133508-97394153-export-your-linkedin-contacts-import-them-into-a-workable-excel-file">here</a>
